...
// Route: /artisans
// Lists all artisans with a card linking to each profile.
    ...
    <>
      <main id="main-content" style={{ backgroundColor: colors.background, minHeight: '100vh' }}>
        ...
        <section
          ...
          style={{ backgroundColor: colors.backgroundWarm, padding: '5rem 2rem', textAlign: 'center' }}
        >
          <p style={{ ...typography.label, marginBottom: '1rem' }}>Our Community</p>
          <h1 id="artisans-heading" style={{ ...typography.h1, fontSize: '3rem', marginBottom: '1rem' }}>
            Meet the Artisans
          </h1>
          <p style={{ ...typography.body, fontSize: '1.125rem', maxWidth: '600px', margin: '0 auto' }}>
        ...
        {/* Artisan grid */}
        <section
          aria-label="Artisan list"
          style={{ padding: '4rem 2rem', maxWidth: '1100px', margin: '0 auto' }}
        >
          <ul style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '2rem', listStyle: 'none', padding: 0, margin: 0 }}>
                ...
                >
                  <article style={{
                    ...
                    <div style={{ padding: '1.5rem' }}>
                      ...
                      <p style={{ ...typography.body, fontSize: '0.9rem', marginBottom: '1.25rem' }}>
                        {artisan.bio}
                      </p>
                      ...
                      <div style={{
                        ...
                        <div>
                          <p style={{ fontFamily: "'Georgia', serif", fontSize: '1.2rem', fontWeight: 500, color: colors.primary, margin: 0 }}>
                            {artisan.productCount}
                          </p>
                          <p style={{ fontFamily: 'sans-serif', fontSize: '0.75rem', color: colors.textMuted, margin: 0 }}>
                            Products
                          </p>
                        </div>
                        <div>
        ...
        <section
          ...
          style={{ backgroundColor: colors.primary, padding: '4rem 2rem', textAlign: 'center' }}
        >
